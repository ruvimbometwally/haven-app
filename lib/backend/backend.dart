...
import 'schema/appreciations_record.dart';
...
export 'schema/appreciations_record.dart';
...
/// Functions to query AppreciationsRecords (as a Stream and as a Future).
Future<int> queryAppreciationsRecordCount({
  Query Function(Query)? queryBuilder,
  int limit = -1,
}) =>
    queryCollectionCount(
      AppreciationsRecord.collection,
      queryBuilder: queryBuilder,
      limit: limit,
    );

Stream<List<AppreciationsRecord>> queryAppreciationsRecord({
  Query Function(Query)? queryBuilder,
  int limit = -1,
  bool singleRecord = false,
}) =>
    queryCollection(
      AppreciationsRecord.collection,
      AppreciationsRecord.fromSnapshot,
      queryBuilder: queryBuilder,
      limit: limit,
      singleRecord: singleRecord,
    );

Future<List<AppreciationsRecord>> queryAppreciationsRecordOnce({
  Query Function(Query)? queryBuilder,
  int limit = -1,
  bool singleRecord = false,
}) =>
...
/// Functions to query ListItemsRecords (as a Stream and as a Future).
Future<int> queryListItemsRecordCount({
  Query Function(Query)? queryBuilder,
  int limit = -1,
}) =>
    queryCollectionCount(
      ListItemsRecord.collection,
      queryBuilder: queryBuilder,
      limit: limit,
    );

Stream<List<ListItemsRecord>> queryListItemsRecord({
  Query Function(Query)? queryBuilder,
  int limit = -1,
  bool singleRecord = false,
}) =>
    queryCollection(
      ListItemsRecord.collection,
      ListItemsRecord.fromSnapshot,
      queryBuilder: queryBuilder,
      limit: limit,
      singleRecord: singleRecord,
    );

Future<List<ListItemsRecord>> queryListItemsRecordOnce({
  Query Function(Query)? queryBuilder,
  int limit = -1,
  bool singleRecord = false,
}) =>
